...
public class RandomScenariosPage extends LoginPage {
	...
	WebElement homeTab;
	@FindBy(xpath = "//tbody/tr[1]/td[2]/div[1]/div[1]/div[1]/div[2]/span[1]/h1[1]/a[1]")
	WebElement save15;

	@FindBy(xpath = "//tbody/tr[1]/td[1]/div[1]/div[2]/div[2]/div[1]/h3[1]/div[1]/div[1]/a[1]/img[1]")
	WebElement cliking;
	...
	WebElement lname;
	@FindBy(xpath = "//body/div[1]/div[1]/div[1]/div[2]/form[1]/div[1]/input[1]")
	WebElement click10;

	@FindBy(xpath = "//tbody/tr[1]/td[2]/input[1]")
	WebElement click14;
	@FindBy(xpath = "//option[contains(text(),'Assets')]")
	WebElement click15;

	@FindBy(xpath = "//tbody/tr[1]/td[2]/div[3]/a[1]/img[1]")
	WebElement click16;
	@FindBy(xpath = "//tbody/tr[1]/td[2]/input[1]")
	WebElement click17;
	...
	@FindBy(xpath = "//a[normalize-space()='Wednesday February 9, 2022']")
	WebElement dat;
	@FindBy(xpath = "//a[contains(text(),'8:00 AM')]")
	WebElement tim;
	@FindBy(xpath = "//tbody/tr[2]/td[2]/div[1]/a[1]/img[1]")
	WebElement act;
	@FindBy(xpath = "//body/div[2]/ul[1]/li[5]/a[1]")
	WebElement act1;
	...
	@FindBy(xpath = "//div[@id='timePickerItem_34']")
	WebElement endTim1;
	...
	WebElement recuureEnd;

	@FindBy(xpath = "//select[@id='calMonthPicker']")
	WebElement selet;

	@FindBy(xpath = "//div[@id='datePicker']//td")
	WebElement datpic;
