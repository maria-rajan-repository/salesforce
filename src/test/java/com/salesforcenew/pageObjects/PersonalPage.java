...
public class PersonalPage extends LoginPage {
	...
	@FindBy(xpath = "//*[@id=\"p4\"]")
	WebElement p4;
	@FindBy(xpath = "//option[contains(text(),'Salesforce Chatter')]")
	WebElement SalesforceChatter;
	@FindBy(id = "duel_select_0")
	WebElement duel_select;
	...
	WebElement report;
	@FindBy(xpath = "//*[contains(@id,'tsidLabel')]")
	WebElement label;
	@FindBy(xpath = "//a[normalize-space()='Reports']")
	WebElement reports;
	@FindBy(xpath = "//li[@id='report_Tab']")
	WebElement tab;
	@FindBy(xpath = "//tbody/tr[1]/td[1]/div[1]/div[4]/div[6]/a[1]")
	WebElement cal;
	...
	@FindBy(xpath = "//tbody/tr[1]/td[1]/div[1]/div[4]/div[6]/div[1]/div[2]")
	WebElement remin;
